...
- AI-powered risk & intent analysis
...
- ✅ Plug Wallet integration (PoC-tested)
- ✅ Zero-knowledge reputation logic (planned)
...
|-------------------------------|----------------|------------------------------------------------------|
| Caller ID Canister (Motoko)   | 🧪 Previously tested | Built & tested in early version, re-deploying Q3    |
| Plug Wallet Auth              | 🧪 Demo ready   | Functional in mockup; ready for integration          |
| Shield UI (Web)               | 🧪 Designed     | Front-end mockup designed (v0.1)                     |
| Reputation Logic              | 🔜 Planned      | Zero-knowledge scoring planned post-pilot            |
| DAO Architecture (v0.1)       | ✅ Documented   | Legal & governance model prepared (see PDF)          |
| AI-Intent Scoring (Demo)      | 🔜 Planned      | Under concept research (signal scoring)              |
...
Built by [Marcel van den Berg](https://twitter.com/CheckVero)  
Connect with us for pilot programs or DAO participation.
